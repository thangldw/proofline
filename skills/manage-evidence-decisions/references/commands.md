...
The bundled verifier does not verify Ed25519. With installed Proofline 2.0.2, verify the exact subjects against a user-selected trusted public key:
...
Bundled verifier không verify Ed25519. Với Proofline 2.0.2 đã cài, verify exact subject với trusted public key do người dùng chọn:
...
Bundled verifier は Ed25519 を検証しません。Installed Proofline 2.0.2 で、exact subject を user-selected trusted public key に対して verify します。
