...
`v0.8.0` is the latest experimental pre-alpha release. It adds previewed, deterministic portable
merge into non-empty databases without overwriting existing records.
...
[release notes](docs/releases/v0.8.0.md) and verify `SHA256SUMS` before installation.
