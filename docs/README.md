...
| [Provenance model](provenance-model.md) | Source identity, exact spans, and Merkle DAG |
| [Stale decision demo](stale-decision-demo.md) | Product story, CI check, outputs, and failure modes |
...
| [Reproducible benchmarks](benchmarks.md) | DEP latency, package size, memory, and qualification limits |
