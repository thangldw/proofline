...
- Evaluator: [Getting started](getting-started.md), [v2.0.0 release](releases/v2.0.0.md), then [architecture](architecture.md).
...
- Plugin reviewer: [OpenAI plugin submission record](submission/openai-plugin.md) and [plugin instructions](../skills/manage-evidence-decisions/SKILL.md).

### Status legend

- Implemented: shipped in Proofline 2.0.0 and backed by code/tests.
...
- Future work: not implemented and never presented as available.

English is authoritative. Each public topic then provides complete Vietnamese and Japanese translations in the same file.

## Tiếng Việt

### Chọn luồng

- Evaluator: [Getting started](getting-started.md), [release v2.0.0](releases/v2.0.0.md), rồi [architecture](architecture.md).
...
- Plugin reviewer: [Hồ sơ OpenAI plugin](submission/openai-plugin.md) và [plugin instruction](../skills/manage-evidence-decisions/SKILL.md).

### Chú giải trạng thái

- Implemented: đã phát hành trong Proofline 2.0.0 và có code/test làm bằng chứng.
...
- Future work: chưa triển khai và không được trình bày như đã có.

English là bản authoritative. Sau đó mỗi chủ đề công khai có bản Vietnamese và Japanese đầy đủ trong cùng file.

## 日本語

### 読み方

- Evaluator：[Getting started](getting-started.md)、[v2.0.0 release](releases/v2.0.0.md)、[architecture](architecture.md)。
...
- Plugin reviewer：[OpenAI plugin submission record](submission/openai-plugin.md) と [plugin instruction](../skills/manage-evidence-decisions/SKILL.md)。

### Status legend

- Implemented：Proofline 2.0.0 で出荷済みで、code/test の裏付けがあります。
...
- Future work：未実装で、利用可能とは示しません。

English が authoritative です。各 public topic は同じ file 内で完全な Vietnamese と Japanese translation を続けます。
