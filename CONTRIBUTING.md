...
1. **Document the JSON CI result.** Add a content-free example for
...
2. **Make the offline report mobile-friendly.** Add a narrow-screen rule to the self-contained HTML
